  ...
  public: {
    Tables: {
      ...
      match_bps_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_bps_tracking_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: false
            referencedRelation: "fixtures"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "match_bps_tracking_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "players"
            referencedColumns: ["id"]
      ...
      match_player_performance: {
        ...
        Relationships: [
          {
            foreignKeyName: "match_player_performance_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: false
            referencedRelation: "fixtures"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "match_player_performance_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "players"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "match_player_performance_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
